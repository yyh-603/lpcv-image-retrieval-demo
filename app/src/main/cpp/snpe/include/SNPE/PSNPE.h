...
/**
 * @brief Set the performance profile level of PSNPE object
 *
 * @param[in] psnpeHandle Handle to access the PSNPE object
 *
 * @param[in] instanceIdx The idx of SNPE object
 *
 * @param[in] performanceProfile The perf profile level
 *
...
/**
 * @brief Set the custom performance profile level of PSNPE object
 *
 * @param[in] psnpeHandle Handle to access the PSNPE object
 *
 * @param[in] instanceIdx The idx of SNPE object
 *
 * @param[in] performanceProfile Handle to accesss the SNPEPerfProfile object
 *
 * @return SNPE_SUCCESS upon successful setting of custom performance profile
 */
SNPE_API
